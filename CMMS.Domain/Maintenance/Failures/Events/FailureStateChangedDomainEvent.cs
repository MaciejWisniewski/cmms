...
{
    public class FailureStateChangedDomainEvent : DomainEventBase
    {
        ...
        public FailureStateChangedDomainEvent(FailureId failureId, ResourceId resourceId, WorkerId workerId, string workerUserName, FailureState failureState, string problemDescription, string note, DateTime failureOccurredOn, DateTime? resolvedOn)
        {
            FailureId = failureId;
